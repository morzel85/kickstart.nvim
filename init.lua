-- Fork of https://github.com/nvim-lua/kickstart.nvim for experimenting with Neovim config...
...
vim.keymap.set('n', '<C-h>', ':vert res -1<CR>', { desc = 'Decrease width' })
vim.keymap.set('n', '<C-j>', ':res -1<CR>', { desc = 'Decrease height' })
vim.keymap.set('n', '<C-k>', ':res +1<CR>', { desc = 'Increase height' })
...
vim.keymap.set('n', '<leader>s:', ':FzfLua command_history<CR>', { desc = '[s]earch [:] command history' })
vim.keymap.set('n', '<leader>sG', ':FzfLua grep<CR>', { desc = '[s]earch [G]rep' })
vim.keymap.set('n', '<leader>sW', ':FzfLua grep_cWORD<CR>', { desc = '[s]earch [W]ORD grep' })
vim.keymap.set('n', '<leader>sb', ':FzfLua builtin<CR>', { desc = '[s]earch [b]uiltin' })
vim.keymap.set('n', '<leader>sc', ':FzfLua lgrep_curbuf<CR>', { desc = '[s]earch grep[c] current buffer' })
